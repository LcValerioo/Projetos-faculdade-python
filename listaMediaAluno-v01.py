...
class PrincipalRAD:
    def __init__(self, win):
        ...
        self.lblMedia.place(x=100, y=300)
...
#Salvar dados para uma planilha excel 
    ...
    def fSalvarDados(self):
        try:
            ...
            df.to_excel(planilha, "Incosistencias", index=False)
...
#Calcular a média e verificar qual é a situação do aluno
